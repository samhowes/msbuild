...
namespace Microsoft.Build.Shared
{
    ...
    /// </summary>
    sealed public class AssemblyNameReverseVersionComparer : IComparer<AssemblyNameExtension>
    {
        /// <summary>
        /// A static instance of the comparer for use in a sort method
        /// </summary>
        public readonly static IComparer<AssemblyNameExtension> GenericComparer = new AssemblyNameReverseVersionComparer();
