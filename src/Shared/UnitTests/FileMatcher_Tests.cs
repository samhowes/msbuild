    ...
    public class FileMatcherTest : IDisposable
    {
        ...
        */
        ...
        public class MockFileSystem
        {
            ...
            public IReadOnlyList<string> GetAccessibleFileSystemEntries(FileMatcher.FileSystemEntity entityType, string path, string pattern, string projectDirectory, bool stripProjectDirectory)
            {
