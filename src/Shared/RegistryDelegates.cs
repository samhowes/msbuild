...
{  /// <summary>
   ...
   /// </summary>
    public delegate RegistryKey OpenBaseKey(RegistryHive hive, RegistryView view);
    ...
    public delegate IEnumerable<string> GetRegistrySubKeyNames(RegistryKey baseKey, string subKey);
    ...
    public delegate string GetRegistrySubKeyDefaultValue(RegistryKey baseKey, string subKey);
}
#endif
