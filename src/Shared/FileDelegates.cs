...
namespace Microsoft.Build.Shared
{
    ...
    public delegate string[] DirectoryGetFiles(string path, string searchPattern);
    ...
    public delegate string[] GetDirectories(string path, string pattern);
    ...
    public delegate void FileCopy(string source, string destination);
    ...
    public delegate FileStream FileCreate(string path);
}