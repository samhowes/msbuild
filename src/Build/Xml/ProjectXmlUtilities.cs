...
namespace Microsoft.Build.Internal
{
    ...
    /// </summary>
    public static partial class ProjectXmlUtilities
    {
        /// <summary>
        /// Gets child elements, ignoring whitespace and comments.
        /// Throws InvalidProjectFileException for unexpected XML node types.
        /// </summary>
        public static XmlElementChildIterator GetVerifyThrowProjectChildElements(XmlElementWithLocation element)
        {
        ...
        /// </summary>
        public static void VerifyThrowProjectNoChildElements(XmlElementWithLocation element)
        {
        ...
        /// </summary>
        public static void ThrowProjectInvalidChildElementDueToDuplicate(XmlElementWithLocation child)
        {
        ...
        /// </summary>
        public static void ThrowProjectInvalidChildElement(string name, string parentName, ElementLocation location)
        {
        ...
        public static bool VerifyValidProjectNamespace(XmlElementWithLocation element)
        {
            return
        ...
        /// </summary>
        public static void VerifyThrowProjectAttributeEitherMissingOrNotEmpty(XmlElementWithLocation xmlElement, string attributeName)
        {
        ...
        /// Verifies that if the attribute is present on the element, its value is not empty
        /// </summary>
        public static void VerifyThrowProjectAttributeEitherMissingOrNotEmpty(XmlElementWithLocation xmlElement, XmlAttributeWithLocation attribute, string attributeName)
        {
        ...
        /// </summary>
        public static void VerifyThrowProjectNoAttributes(XmlElementWithLocation element)
        {
        ...
        /// </summary>
        public static void VerifyThrowProjectInvalidAttribute(bool condition, XmlAttributeWithLocation attribute)
        {
            if (!condition)
            {
                ThrowProjectInvalidAttribute(attribute);
        ...
        /// </summary>
        public static void VerifyThrowProjectRequiredAttribute(XmlElementWithLocation element, string attributeName)
        {
        ...
        /// </summary>
        public static void VerifyThrowProjectAttributes(XmlElementWithLocation element, HashSet<string> validAttributes)
        {
            foreach (XmlAttributeWithLocation attribute in element.Attributes)
            {
        ...
        /// </summary>
        public static void ThrowProjectInvalidAttribute(XmlAttributeWithLocation attribute)
        {
        ...
        /// </summary>
        public static XmlAttributeWithLocation SetOrRemoveAttribute(XmlElementWithLocation element, string name, string value)
        {
        ...
        /// UNDONE: Make this return a bool if the attribute did not change, so we can avoid dirtying.
        /// </summary>
        public static XmlAttributeWithLocation SetOrRemoveAttribute(XmlElementWithLocation element, string name, string value, bool allowSettingEmptyAttributes)
        {
        ...
        /// </summary>
        public static string GetAttributeValue(XmlAttributeWithLocation attribute, bool returnNullForNonexistentAttributes)
        {
            if (attribute == null)
            {
        ...
        /// </summary>
        public static string GetAttributeValue(XmlElementWithLocation element, string attributeName)
        {
        ...
        /// of nullIfNotExists.
        /// </summary>
        public static string GetAttributeValue(XmlElementWithLocation element, string attributeName, bool nullIfNotExists)
        {
