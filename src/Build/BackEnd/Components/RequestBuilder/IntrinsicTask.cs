...
namespace Microsoft.Build.BackEnd
{
    ...
    /// </summary>
    public abstract class IntrinsicTask
    {
        /// <summary>
        ...
        /// </summary>
        public TargetLoggingContext LoggingContext
        {
            get;
            private set;
        }
        ...
        public static IntrinsicTask InstantiateTask(ProjectTargetInstanceChild taskInstance, TargetLoggingContext loggingContext, ProjectInstance projectInstance, bool logTaskInputs)
        {
        ...
        public abstract void ExecuteTask(Lookup lookup);
