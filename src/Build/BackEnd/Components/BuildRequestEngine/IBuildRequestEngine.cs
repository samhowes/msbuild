...
namespace Microsoft.Build.BackEnd
{
    ...
    public delegate void RequestCompleteDelegate(BuildRequest request, BuildResult result);

    /// <summary>
    /// Callback for event raised when a request is resumed
    /// </summary>
    /// <param name="request">The request being resumed</param>
    public delegate void RequestResumedDelegate(BuildRequest request);
    ...
    public delegate void RequestBlockedDelegate(BuildRequestBlocker blocker);
    ...
    public delegate void EngineStatusChangedDelegate(BuildRequestEngineStatus newStatus);
    ...
    public delegate void NewConfigurationRequestDelegate(BuildRequestConfiguration config);

    /// <summary>
    /// Callback for event raised when a resource is requested.
    /// </summary>
    /// <param name="request">The resources being requested</param>
    public delegate void ResourceRequestDelegate(ResourceRequest request);

    /// <summary>
    /// Callback for event raised when there is an unhandled exception in the engine.
    /// </summary>
    /// <param name="e">The exception.</param>
    public delegate void EngineExceptionDelegate(Exception e);
    ...
    /// </summary>
    public enum BuildRequestEngineStatus
    {
        /// <summary>
    ...
    /// </summary>
    public interface IBuildRequestEngine
    {
        #region Events
        /// <summary>
