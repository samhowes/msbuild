...
namespace Microsoft.Build.Construction
{
    ...
    public class ProjectOtherwiseElement : ProjectElementContainer
    {
        ...
        /// </summary>
        public ProjectOtherwiseElement(ProjectOtherwiseElementLink link)
            : base(link)
        {
        }
        ...
        /// </summary>
        public ProjectOtherwiseElement(XmlElementWithLocation xmlElement, ProjectElementContainer parent, ProjectRootElement project)
        ...
        /// </summary>
        public static ProjectOtherwiseElement CreateDisconnected(ProjectRootElement containingProject)
        {
