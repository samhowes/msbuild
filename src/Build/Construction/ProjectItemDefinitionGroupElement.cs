...
namespace Microsoft.Build.Construction
{
    ...
    public class ProjectItemDefinitionGroupElement : ProjectElementContainer
    {
        ...
        /// </summary>
        public ProjectItemDefinitionGroupElement(ProjectItemDefinitionGroupElementLink link)
            : base(link)
        {
        }
        ...
        /// </summary>
        public ProjectItemDefinitionGroupElement(XmlElement xmlElement, ProjectRootElement parent, ProjectRootElement containingProject)
        ...
        /// </summary>
        public static ProjectItemDefinitionGroupElement CreateDisconnected(ProjectRootElement containingProject)
        {
