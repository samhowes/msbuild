...
namespace Microsoft.Build.Construction
{
    ...
    public class ProjectWhenElement : ProjectElementContainer
    {
        ...
        /// </summary>
        public ProjectWhenElement(ProjectWhenElementLink link)
            : base(link)
        {
        }
        ...
        /// </summary>
        public ProjectWhenElement(XmlElement xmlElement, ProjectChooseElement parent, ProjectRootElement containingProject)
        ...
        /// </summary>
        public static ProjectWhenElement CreateDisconnected(string condition, ProjectRootElement containingProject)
        {
